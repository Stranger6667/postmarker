...
class TestSimpleSend:
    ...
    @pytest.mark.parametrize(
        "value", ("first@example.com,second@example.com", ["first@example.com", "second@example.com"])
    )
...
class TestBatchSend:
    ...
    def test_dict(self, postmark, email, postmark_request):
        ...
        expected = {"From": email.From, "To": email.To, "TextBody": email.TextBody, "Headers": [], "Attachments": []}
...
class TestEmail:
    ...
    def test_attach_unknown_content_type(self, email, postmark_request):
        ...
        assert postmark_request.call_args[1]["json"]["Attachments"] == [
            {"Name": "report.blabla", "Content": "dGVzdCBjb250ZW50", "ContentType": "application/octet-stream"}
        ]
